...
<title>show add picture page</title>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".delete").click(function(){
			$(this).parents(".hiden").css("display","none");
		});
...
<body>
  ...
  <tr>
    ...
    <h2>Welcome to Myalbum, ${user.username}.&nbsp;&nbsp; Album:${album.name } </h2>
    <p align="right"><g:link controller="album" action="deleteAlbum" id="${album.name }">delete</g:link></p>
    <hr/>
    	<div style="float:left;width:100%">
    		<g:uploadForm name="myUpload" controller="album">
			 <table width="100%"  border="0" cellspacing="5">
				  <tr>
				  	<td width="35%"> <div align="center">Album Name:</div></td>
			      	
			      	<td width="35%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${album.name }</td>
				  <td rowspan="5" align="center" >
			        <g:actionSubmit class="button"  value="Add" action="uploadPicture"/>			         </td>
				  </tr>
			    <tr>
			      <td width="35%"> <div align="center">Picture Name:</div></td>
			      <td width="35%">
			      <input name="picture_name" type="text" size="30" style="height:25px"/>			      </td>
		        </tr>
			    <tr>
			      <td colspan="2" align="center">
							<input type="file" name="upload" /><div align="right"><input value="${user.id}" type="text" name="user_id" style="display:none"/>
			      		
			      		<input value="${album.id}" type="text" name="album_id" style="display:none"/>
			      		    </div></td>
		        </tr>
			  </table>
			</g:uploadForm>
				...
				<table>
					<thead>
						<tr>
							...
							<th>Album :</th>
							<th>Picture:</th>
							<g:sortableColumn property="pic_date" defaultOrder="desc" title="Picture Name:" titleKey="Picture.pic_date" />
						</tr>
					</thead>
					<tbody>
						<g:each in="${picture_list}">
							
									<tr style="height: 50px" class="hiden" >
										<td>${it.album.user.username }</td>
										<td>${it.album.name }</td>
										<td><img src="../../${it.path }" width="50" height="50" />

										</td>
										<td>${it.name }
											
											</td>
											<td><g:remoteLink class="delete" action="delete" id="${it.name}">delete</g:remoteLink></td>
									</tr>
							</g:each>
					</tbody>
				</table>
    ...
    <td width="50%" id="addAlbumInfo" style="display:none">
    <h2>Welcome to Myalbum, ${user.username}.</h2>
    <hr/>
    	<div style="float:left;width:100%;padding-top:100px"">
    		<g:form controller="album">
			  <table width="100%"  border="0">
			    <tr>
			      <td width="116"> <div align="right">Album Name:</div></td>
			      <td width="234">

...
<title>show Search result page</title>
...
<body>
  ...
  <tr>
    ...
    <td width="50%"  valign="top" id="defaultInfo" style="display:block">
    	<g:form controller="album" id="searchForm">
    	<table style="padding-top:20px;padding-bottom:20px">
    	<tr >
	      <td width="15%" ><input name="search" type="text" style="width:95%;height:25px"/>
	      					<input value="${user.id}" type="text" name="user_id"  style="display:none"/>
	      					</td>
	      <td width="15%"  align="center"> 
	      					<g:actionSubmit class="button" value="Search" action="showResult"/>
						</td></tr>
						</table>
	     	</g:form>
					...
					<thead>
						...
						<g:each in="${picture_list}">
							<tr style="height: 50px">
								...
								<td><img src="../../${it.path }" width="120px" height="120px"></img></td>
								<td align="center">${it.name }</td>
								<td><g:link controller="friend" action="friendPicture" id="${it.name}"> See it</g:link></td>
							</tr>
						</g:each>

    ...
    <script src="http://google-maps-utility-library-v3.googlecode.com/svn/trunk/routeboxer/src/RouteBoxer.js" type="text/javascript"></script>
     ...
     <script type="text/javascript">
     	...
     	$(function(){
     		...
     		$("#exit").click(function(){	
     			with(document.getElementById("unLoginSearchForm")){
     				method = "post";
					action = "exit.do";
					submit();
     			}
	  ...
	  <table width="86%" border="0" style="background-color:#0A5CA7" id="head">
	    <tr bordercolor="#FFFFFF">
	     ...
	     <td width="7%" style="color:white;font-size:15px;" align="right">用户名:</td>
	      ...
	      <td width="8%" style=";font-size:15px"><a href="../form/regist.jsp">注册 |</a></td>
...
<div style="clear:both">
  <div style="float:left;background-color:#FFFFFF;height:600px;width:30%">
  	...
  	<table width="100%" style="border-bottom:2px;border:none;" >
  	<tr>
  		<td><h1 style="color:#0A5CA7">${emptyList}</h1></td>
  	</tr>

...
namespace _20120606Pose
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void TrackPose(Skeleton skeleton)
        {
            if (IsPose(skeleton, this._StartPose))
            {
                PoseName.Text = this._StartPose.Title;
            }
            else if (IsPose(skeleton, this._PoseLibrary[0]))
            {
                PoseName.Text = this._PoseLibrary[0].Title;
            }
            else if (IsPose(skeleton, this._PoseLibrary[1]))
            {
                PoseName.Text = this._PoseLibrary[1].Title;
            }
        }
        ...
        private void PopulatePoseLibrary()
        {
            ...
            this._StartPose.Title = "Stretching";

...
namespace _20120601GetCoordinate
{
    using System.IO;
    ...
    public partial class MainWindow : Window
    {
        ...
        private void SensorSkeletonFrameReady(object sender, SkeletonFrameReadyEventArgs e)
        {
            ...
            using (SkeletonFrame skeletonFrame = e.OpenSkeletonFrame())
            {
                if (skeletonFrame != null)
                {
                    ...
                    if (skeleton == null)
                    {
                        JointInfoPanel.Visibility = Visibility.Collapsed;
                    }
                    else
                    {
                        TrackJoint(skeleton.Joints[JointType.HandLeft], Brushes.Red);
                        TrackJoint(skeleton.Joints[JointType.HandRight], Brushes.Pink);
                    }
                }
            }
        ...
        private void TrackJoint(Joint joint, Brush brush)
        {
            ...
            {
                JointInfoPanel.Visibility = System.Windows.Visibility.Collapsed;
            }
            else
            {
                JointInfoPanel.Visibility = System.Windows.Visibility.Visible;
                
                Point jointPoint = GetJointPoint(joint);
                Canvas container = new Canvas();


                double z = joint.Position.Z * _FeetPerMeters;
                ...
                //Skeleton Image coordinate
                positionText.Text = string.Format("<{0:0.00},{1:0.00},{2:0.00}>", joint.Position.X, joint.Position.Y, z);
                ...
                this.JointInfoPanel.Children.Add(container);
            }
        }

        ...
        private void SensorSkeletonFrameReady(object sender, SkeletonFrameReadyEventArgs e)
        {
            ...
            using (SkeletonFrame skeletonFrame = e.OpenSkeletonFrame())
            {
                if (skeletonFrame != null)
                {
                    ...
                    {
                        TrackHand(skeleton.Joints[JointType.HandLeft], LeftHandElement, LeftHandScaleTransform, true);
                        TrackHand(skeleton.Joints[JointType.HandRight], RightHandElement, RightHandScaleTransform, false);
                    }
                }
            }
...
/****************************************************************************************************************************/
        ...
        private void TrackHand(Joint hand, FrameworkElement cursorElement, ScaleTransform cursorScale, bool isLeft)
        
        {
            if (hand.TrackingState != JointTrackingState.NotTracked)
            
            {
                double z = hand.Position.Z * _FeetPerMeters;
                ...
                Point jointPoint = GetJointPoint(hand);
                ...
                //fault in book
                cursorScale.ScaleX = 1340 / (z * 100) * ((isLeft) ? -1 : 1);
                cursorScale.ScaleY = 1340 / (z * 100);
